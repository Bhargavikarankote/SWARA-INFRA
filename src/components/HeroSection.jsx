  ...
  return (
    <div className="hero-container">
      ...
      <div className="hero-social-links">
        ...
        <a href="#" className="hero-social-link" aria-label="YouTube">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h5>We Focus on you</h5>
              <p>
                We Provide Expertise and genuine committed to qualify on every
                project no matter the size, market, or delivery method.
              </p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h5>Project Leadership</h5>
              <p>
                We will make your building construction Project proceed in a
                straightforward manner with the least possible impact on your
                normal operation.
              </p>
            </div>
          </div>
